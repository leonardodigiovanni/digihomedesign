...
export default async function Page() {
  ...
  const { prev, next } = getCategoryGroupNeighbors('tessuti', 267, disabledPages)
  const CERCA = 'Divani'
          ...
          <div className="vetrina-foto-row">
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/tessuti/divani/variegato.webp" alt="Divano modulare in tessuti variegati" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
              <div style={{ padding: '14px 16px' }}>
                <span className="testo-articoli">Variegato</span>
              </div>
            </div>
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/tessuti/divani/omogeneo.webp" alt="Divano angolare in tinta unita" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
              <div style={{ padding: '14px 16px' }}>
                <span className="testo-articoli">Omogeneo</span>
              </div>
            </div>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>

...
export default async function Page() {
  ...
  const { prev, next } = getCategoryGroupNeighbors('arredi', 264, disabledPages)
  const CERCA = 'Quadri'
  ...
  return (
    <div className="fs-15" style={{ padding: '0 0 64px', color: '#444', lineHeight: 1.8 }}>
      <p className="fs-12" style={{ color: '#000', marginBottom: 8, textShadow: 'none' }}>
        <Link href="/arredi" style={{ color: '#888', textDecoration: 'underline' }}>Arredi</Link> / Quadri<ShortcutStar />
      </p>
      <h1 className="effetto-3d fs-28" style={{ fontWeight: 700, marginBottom: 8 }}>Quadri a Palermo</h1>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          <div className="vetrina-foto-row">
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/arredi/quadri/cardplayers.jpg" alt="I giocatori di carte" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
              <div style={{ padding: '14px 16px' }}>
                <span className="testo-articoli">I giocatori di carte</span>
              </div>
            </div>
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/arredi/quadri/salvator-mundi.jpg" alt="Salvator Mundi" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
              <div style={{ padding: '14px 16px' }}>
                <span className="testo-articoli">Salvator Mundi</span>
              </div>
            </div>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <p className="testo-articoli" style={{ margin: 0 }}>
              Vendiamo quadri di artisti locali e riproduzioni fatte a mano di quadri famosi.
            </p>
          </div>
        </div>
        ...
        <StickyBottomBarContent>
          <Link href="/arredi" className="btn-black fs-12">← Arredi</Link>
          {prev ? <Link href={prev.href} className="btn-blue fs-12">← {prev.label}</Link> : <NavDropdownTriggerButton dropdownId="cat-termodinamica" label="← Termodinamica" />}
          <CtaPreventivo />
          <CtaCantiere />

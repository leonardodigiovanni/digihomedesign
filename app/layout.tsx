...
export const metadata: Metadata = {
  ...
  title: {
    ...
    template: 'DIGI Home Design — %s',
  },
  description: 'DIGI Home Design — 30+ Anni esperienza - Infissi, Verande, Porte Blindate, Persiane, Scale, Tettoie. Più qualità, stesso prezzo di mercato.',
  openGraph: {

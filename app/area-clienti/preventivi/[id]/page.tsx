...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const [artRows] = await db.query(
      `SELECT pa.*, l.abbr, l.profilo_frontale_mm, l.foto_url AS listino_foto_url, l.richiede_tipo_colore_acc, l.escluso AS listino_escluso, l.categoria AS listino_categoria FROM preventivo_articoli pa LEFT JOIN listini l ON l.id = pa.listino_id WHERE pa.preventivo_id = ? ORDER BY pa.id ASC`,
      [prevId]
    ) as [Record<string, unknown>[], unknown]

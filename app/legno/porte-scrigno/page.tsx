...
export default async function Page() {
  ...
  const { prev, next } = getCategoryGroupNeighbors('legno', 243, disabledPages)
  const CERCA = 'Porte Scrigno'
          ...
          <div className="vetrina-foto-row">
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/legno/porte-scrigno/bianca.webp" alt="Porta scrigno bianca" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
            ...
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/legno/porte-scrigno/noce.webp" alt="Porta scrigno in noce" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
              <div style={{ padding: '14px 16px' }}>
                <span className="testo-articoli">Noce</span>
              </div>
            </div>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>

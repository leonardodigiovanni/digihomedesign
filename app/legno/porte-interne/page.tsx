...
export default async function Page() {
  ...
  const { prev, next } = getCategoryGroupNeighbors('legno', 242, disabledPages)
  const CERCA = 'Porte Interne'
  ...
  return (
    <div className="fs-15" style={{ padding: '0 0 64px', color: '#444', lineHeight: 1.8 }}>
      <p className="fs-12" style={{ color: '#000', marginBottom: 8, textShadow: 'none' }}>
        <Link href="/legno" style={{ color: '#888', textDecoration: 'underline' }}>Legno</Link> / Porte Interne<ShortcutStar />
      </p>
      <h1 className="effetto-3d fs-28" style={{ fontWeight: 700, marginBottom: 8 }}>Porte Interne a Palermo</h1>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          <div className="vetrina-foto-row">
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/legno/porte-interne/legno laccato.webp" alt="Porta interna in legno laccato" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
              <div style={{ padding: '14px 16px' }}>
                <span className="testo-articoli">Legno laccato</span>
              </div>
            </div>
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/legno/porte-interne/alluminio vetro.webp" alt="Porta interna in alluminio e vetro" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
              <div style={{ padding: '14px 16px' }}>
                <span className="testo-articoli">Alluminio e vetro</span>
              </div>
            </div>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        ...
        <StickyBottomBarContent>
          ...
          {prev ? <Link href={prev.href} className="btn-blue fs-12">← {prev.label}</Link> : <NavDropdownTriggerButton dropdownId="cat-metallurgia" label="← Ferro e Acciaio" />}
          <CtaPreventivo />
          <CtaCantiere />

...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.digi-home-design.com/chi-siamo/contatti' },
}
  ...
  return (
    <div className="fs-15" style={{ padding: '0 0 64px', color: '#444', lineHeight: 1.8 }}>
      <p className="fs-12" style={{ color: '#000', marginBottom: 8, textShadow: 'none' }}>
        <Link href="/chi-siamo" style={{ color: '#888', textDecoration: 'underline' }}>Chi Siamo</Link> / Contatti<ShortcutStar />
      </p>

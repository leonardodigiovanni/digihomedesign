          ...
          <div className="vetrina-foto-row">
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/metallurgia/pannelli-bugnato-alluminio/photo_2026-04-15_23-13-47.jpg" alt="Pannelli bugnato in alluminio" fill sizes="240px" style={{ objectFit: 'cover' }} />
              </div>

...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.digi-home-design.com/antintrusione-e-sicurezza/porte-blindate-pvc' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Porte Blindate Rivestimento PVC a Palermo — Classe 3, 4, 5 e 6',
    description: 'Porte blindate a Palermo con rivestimento esterno in PVC: fornitura e installazione classe 3-6 con serrature di sicurezza multipunto. Misure standard e su misura.',
    url: 'https://www.digi-home-design.com/antintrusione-e-sicurezza/porte-blindate-pvc',
    type: 'website',
  },
}
...
export default async function Page() {
  ...
  const { prev, next } = getAntintrusioneNeighbors(2126, disabledPages)
  ...
  return (
    <div className="fs-15" style={{ padding: '0 0 64px', color: '#444', lineHeight: 1.8 }}>
      <p className="fs-12" style={{ color: '#000', marginBottom: 8, textShadow: 'none' }}>
        <span style={{ color: '#888' }}>Antintrusione e Sicurezza</span> / Porte Blindate Riv. PVC<ShortcutStar />
      </p>

  ...
  const result = normalized.map((item, index) => {
    if (item.tipo === 'caratteristica' || item.id === 0) {
      ...
      return {
        ...
        foto_url: artCar?.foto_url ?? null, escluso: Number(artCar?.escluso ?? 0), bar_color: null as string | null, bar_color_acc: null as string | null,
      }
    }
    ...
    return {
      ...
      profilo_mm: art.profilo_frontale_mm ?? 80, foto_url: art.foto_url ?? null, escluso: Number(art.escluso ?? 0),

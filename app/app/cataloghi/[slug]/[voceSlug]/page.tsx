  ...
  return (
    <div className="fs-15" style={{ padding: '0 0 80px', color: '#444', lineHeight: 1.8 }}>
      ...
      <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
        <Link href={`/app/cataloghi/${slug}`} className="btn-black fs-12" style={{ flex: 1, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', height: 42, padding: '0 20px', borderRadius: 21, textDecoration: 'none', fontFamily: 'monospace' }}>
          ← Torna a cataloghi
        </Link>
        {cartNonVuoto && (

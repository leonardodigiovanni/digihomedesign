...
export default function Page() {
  return (
    <div style={{ padding: '24px 12px 100px' }}>
      ...
      <h1 style={{ fontSize: 18, fontWeight: 700, fontFamily: 'monospace', marginBottom: 4 }}>
      ...
      <div style={{ marginTop: 32, paddingTop: 16, borderTop: '1px solid #eee' }}>
        <Link href="/app" style={{ fontSize: 12, fontFamily: 'monospace', color: '#888', textDecoration: 'underline' }}>
          ← Torna alla home
        </Link>
      </div>

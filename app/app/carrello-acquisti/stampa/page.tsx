...
import StampaAcquistiClient from '@/app/area-clienti/carrello-acquisti/stampa/stampa-client'
...
export default async function Page() {
  ...
  if (!digiCartAcquisti) redirect('/app/carrello-acquisti')
  ...
  if (arts.length === 0) redirect('/app/carrello-acquisti')

...
import CarrelloAcquistiClient from '@/app/area-clienti/carrello-acquisti/carrello-acquisti-client'
...
export default async function Page() {
  ...
  return (
    <div style={{ padding: '0 0 80px', color: '#444', fontSize: 15, lineHeight: 1.8, marginLeft: 3, marginRight: 3 }}>
      <CarrelloAcquistiClient
        articoli={articoli}

...
const subcategories = [
  { id: 269, href: '/servizi/riparazioni',          label: 'Riparazioni',          desc: 'Riparazioni rapide e affidabili per infissi, serramenti, arredi e impianti.' },
  { id: 270, href: '/servizi/montaggio',            label: 'Montaggio',            desc: 'Montaggio professionale di mobili, arredi, infissi e strutture su misura.' },
  { id: 271, href: '/servizi/manutenzione',         label: 'Manutenzione',         desc: 'Manutenzione ordinaria e straordinaria per mantenere casa e ufficio in perfetto stato.' },
  { id: 272, href: '/servizi/contratti-di-pulizia', label: 'Contratti di Pulizia', desc: 'Contratti di pulizia periodica per ambienti residenziali e commerciali a Palermo.' },
]
  ...
  return (
    <div className="fs-15" style={{ padding: '0 4px 64px', color: '#444', lineHeight: 1.8 }}>
      <p className="fs-12" style={{ color: '#000', marginBottom: 8, textShadow: 'none' }}>
        <Link href="/" style={{ color: '#888', textDecoration: 'underline' }}>Home</Link> / Servizi<ShortcutStar />
      </p>

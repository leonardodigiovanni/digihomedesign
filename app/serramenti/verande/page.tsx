...
export const metadata: Metadata = {
  title: 'Verande a Palermo â€” Alluminio e Vetro su Misura',
...
export default async function Page() {
  const catalogo = await getCatalogoData('serramenti', 'verande')
  ...
  return (
    <div className="fs-15" style={{ padding: '0 0 64px', color: '#444', lineHeight: 1.8 }}>
      <p className="fs-12" style={{ color: '#000', marginBottom: 8, textShadow: 'none' }}>
        <Link href="/serramenti" style={{ color: '#888', textDecoration: 'underline' }}>Serramenti</Link> / Verande<ShortcutStar />
      </p>
      ...
      <p className="IsDebug fs-11" style={{ marginTop: 8 }}>{(() => {
        const cerca = catalogo
          ...
          : 'serramenti/verande/non trovata'

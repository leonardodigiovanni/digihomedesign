...
export const metadata: Metadata = {
  title: 'Verande in Alluminio a Palermo â€” Su Misura con Vetro Temperato',
  ...
  alternates: { canonical: 'https://www.digi-home-design.com/comfort-e-spazi-esterni/verande-in-alluminio' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Verande in Alluminio a Palermo â€” Su Misura con Vetro Temperato',
    description: 'Verande in alluminio a Palermo su misura: vetri fissi, scorrevoli, ante a libro e sistemi bioclimatici. Profili a taglio termico, vetri basso-emissivi. Preventivo gratuito.',
    url: 'https://www.digi-home-design.com/comfort-e-spazi-esterni/verande-in-alluminio',
    type: 'website',
  },
}
...
export default async function Page() {
  ...
  const { prev, next } = getComfortNeighbors(203, disabledPages)
  const catalogo = await getCatalogoData('serramenti', 'verande-in-alluminio')
  ...
  return (
    <div className="fs-15" style={{ padding: '0 0 64px', color: '#444', lineHeight: 1.8 }}>
      <p className="fs-12" style={{ color: '#000', marginBottom: 8, textShadow: 'none' }}>
        <span style={{ color: '#888' }}>Comfort e Spazi Esterni</span> / Verande in Alluminio<ShortcutStar />
      </p>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        {catalogo && (
          <CatalogoWrapper
            ...
            fixedCat="serramenti"
            fixedSottocat="verande-in-alluminio"
          />
        )}
      ...
      <p className="IsDebug fs-11" style={{ marginTop: 8 }}>{(() => {
        const cerca = catalogo
          ...
          : 'serramenti/verande-in-alluminio/non trovata'

...
export default async function Page() {
  ...
  const { prev, next } = getProdottiNeighbors(293, disabledPages)
  const catalogo = await getCatalogoData('serramenti', 'infissi-in-legno-alluminio')
    ...
    <div className="fs-15" style={{ padding: '0 0 64px', color: '#444', lineHeight: 1.8 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div className="vetrina-foto-row">
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/legno/infissi-in-legno-alluminio/finestra-legno-alluminio.jpg" alt="Finestra in legno-alluminio" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
            ...
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/legno/infissi-in-legno-alluminio/IMG_9964_thumb.webp" alt="Porta finestra in legno-alluminio" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
              <div style={{ padding: '14px 16px' }}>
                <span className="testo-articoli">Porta finestra</span>
              </div>
            </div>
          </div>
        ...
        {catalogo && (
          <CatalogoWrapper
            ...
            fixedCat="serramenti"
            fixedSottocat="infissi-in-legno-alluminio"
          />
        )}
      ...
      <p className="IsDebug fs-11" style={{ marginTop: 8 }}>{(() => {
        const cerca = catalogo
          ...
          : 'serramenti/infissi-in-legno-alluminio/non trovata'

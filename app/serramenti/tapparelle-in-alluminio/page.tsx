...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.digi-home-design.com/riqualificazione-energetica/tapparelle-in-alluminio' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Tapparelle in Alluminio a Palermo — Manuali su Misura',
    description: 'Tapparelle manuali in alluminio estruso a Palermo: a cinghia, manovella o moschettone, con avvolgitore a cassonetto incassato o a vista. Fornitura e posa con garanzia.',
    url: 'https://www.digi-home-design.com/riqualificazione-energetica/tapparelle-in-alluminio',
    type: 'website',
  },
}
...
export default async function Page() {
  ...
  const { prev, next } = getProdottiNeighbors(298, disabledPages)
  ...
  return (
    <div className="fs-15" style={{ padding: '0 0 64px', color: '#444', lineHeight: 1.8 }}>
      <p className="fs-12" style={{ color: '#000', marginBottom: 8, textShadow: 'none' }}>
        <span style={{ color: '#888' }}>Riqualificazione Energetica</span> / Tapparelle in Alluminio<ShortcutStar />
      </p>

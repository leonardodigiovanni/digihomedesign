...
export const metadata: Metadata = {
  title: 'Tapparelle in Alluminio a Palermo — Manuali su Misura',
  description: 'Tapparelle manuali in alluminio estruso a Palermo: a cinghia, manovella o moschettone, con avvolgitore a cassonetto incassato o a vista. Fornitura e posa con garanzia.',
  alternates: { canonical: 'https://www.digi-home-design.com/serramenti/tapparelle-in-alluminio' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Tapparelle in Alluminio a Palermo — Manuali su Misura',
    description: 'Tapparelle manuali in alluminio estruso a Palermo: a cinghia, manovella o moschettone, con avvolgitore a cassonetto incassato o a vista. Fornitura e posa con garanzia.',
    url: 'https://www.digi-home-design.com/serramenti/tapparelle-in-alluminio',
    type: 'website',
  },
}
...
export default async function Page() {
  const catalogo = await getCatalogoData('serramenti', 'tapparelle-in-alluminio')
  ...
  return (
    <div className="fs-15" style={{ padding: '0 0 64px', color: '#444', lineHeight: 1.8 }}>
      <p className="fs-12" style={{ color: '#000', marginBottom: 8, textShadow: 'none' }}>
        <Link href="/serramenti" style={{ color: '#888', textDecoration: 'underline' }}>Serramenti</Link> / Tapparelle in Alluminio<ShortcutStar />
      </p>
      <h1 className="effetto-3d fs-28" style={{ fontWeight: 700, marginBottom: 8 }}>Tapparelle in Alluminio a Palermo</h1>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div className="vetrina-foto-row">
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/serramenti/tapparelle-manuali/legno.png" alt="Tapparella in alluminio effetto legno" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
            ...
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/serramenti/tapparelle-manuali/tapparelle.jpg" alt="Tapparelle in alluminio su misura" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
              <div style={{ padding: '14px 16px' }}>
        ...
        {catalogo && (
          <CatalogoWrapper
            ...
            fixedCat="serramenti"
            fixedSottocat="tapparelle-in-alluminio"
          />
        )}
      ...
      <p className="IsDebug fs-11" style={{ marginTop: 8 }}>{(() => {
        const cerca = catalogo
          ...
          : 'serramenti/tapparelle-in-alluminio/non trovata'

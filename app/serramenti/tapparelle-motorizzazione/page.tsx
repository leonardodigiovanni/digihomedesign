...
export const metadata: Metadata = {
  ...
  description: 'Motorizzazione tapparelle a Palermo: motori tubulari Somfy, Nice, Came con telecomando, timer e integrazione domotica. Retrofit su avvolgibili esistenti in PVC, alluminio o acciaio. Preventivo gratuito.',
  alternates: { canonical: 'https://www.digi-home-design.com/serramenti/tapparelle-motorizzazione' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Tapparelle Motorizzazione a Palermo — Automazione e Domotica',
    description: 'Motorizzazione tapparelle a Palermo: motori tubulari Somfy, Nice, Came con telecomando, timer e integrazione domotica. Retrofit su avvolgibili esistenti in PVC, alluminio o acciaio. Preventivo gratuito.',
    url: 'https://www.digi-home-design.com/serramenti/tapparelle-motorizzazione',
    type: 'website',
  },
}
  ...
  return (
    <div className="fs-15" style={{ padding: '0 0 64px', color: '#444', lineHeight: 1.8 }}>
      <p className="fs-12" style={{ color: '#000', marginBottom: 8, textShadow: 'none' }}>
        <Link href="/serramenti" style={{ color: '#888', textDecoration: 'underline' }}>Serramenti</Link> / Tapparelle Motorizzazione<ShortcutStar />
      </p>
      <h1 className="effetto-3d fs-28" style={{ fontWeight: 700, marginBottom: 8 }}>Tapparelle Motorizzazione a Palermo</h1>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        {catalogo && (
          <CatalogoWrapper
            ...
            fixedCat="serramenti"
            fixedSottocat="tapparelle-motorizzazione"
          />
        )}
      ...
      <p className="IsDebug fs-11" style={{ marginTop: 8 }}>{(() => {
        const cerca = catalogo
          ...
          : 'serramenti/tapparelle-motorizzazione/non trovata'

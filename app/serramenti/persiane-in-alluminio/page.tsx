...
export default async function Page() {
  const catalogo = await getCatalogoData('serramenti', 'persiane-in-alluminio')
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div className="vetrina-foto-row">
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/serramenti/persiane-in-alluminio/persiana.JPG" alt="Persiana in alluminio" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
            ...
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/serramenti/persiane-in-alluminio/bianca.png" alt="Persiana bianca" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
              <div style={{ padding: '14px 16px' }}>
        ...
        {catalogo && (
          <CatalogoWrapper
            ...
            fixedCat="serramenti"
            fixedSottocat="persiane-in-alluminio"
          />
        )}

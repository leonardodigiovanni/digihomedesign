...
const subcategories = [
  ...
  { href: '/serramenti/imbotti',                  label: 'Imbotti & Cassonetti',     desc: 'Imbotti in alluminio e PVC per il rivestimento dei vani finestra.' },
  ...
  { href: '/serramenti/vetrate',                  label: 'Vetrate',                  desc: 'Vetrate commerciali in alluminio per negozi, show-room e attività.' },

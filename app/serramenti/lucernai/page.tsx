...
export const metadata: Metadata = {
  title: 'Lucernai a Palermo â€” Illuminazione Naturale per Tetti e Coperture',
...
export default async function Page() {
  ...
  const { prev, next } = getCategoryGroupNeighbors('serramenti', 209, disabledPages)
  const catalogo = await getCatalogoData('serramenti', 'lucernai')
  ...
  return (
    <div className="fs-15" style={{ padding: '0 0 64px', color: '#444', lineHeight: 1.8 }}>
      <p className="fs-12" style={{ color: '#000', marginBottom: 8, textShadow: 'none' }}>
        <Link href="/serramenti" style={{ color: '#888', textDecoration: 'underline' }}>Serramenti</Link> / Lucernai<ShortcutStar />
      </p>
      ...
      <p className="IsDebug fs-11" style={{ marginTop: 8 }}>{(() => {
        const cerca = catalogo
          ...
          : 'serramenti/lucernai/non trovata'

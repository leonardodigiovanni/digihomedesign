...
export default async function Page() {
  const catalogo = await getCatalogoData('serramenti', 'cassonetti-in-pvc')
    ...
    <div className="fs-15" style={{ padding: '0 0 64px', color: '#444', lineHeight: 1.8 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div className="vetrina-foto-row">
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/serramenti/imbotti-in-alluminio/20240802_183635.jpg" alt="Cassonetto in PVC installato" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
            ...
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/serramenti/imbotti-in-alluminio/cassonetto_mediterraneo-800x533.jpg" alt="Cassonetto in PVC" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
              <div style={{ padding: '14px 16px' }}>
        ...
        {catalogo && (
          <CatalogoWrapper
            ...
            fixedCat="serramenti"
            fixedSottocat="cassonetti-in-pvc"
          />
        )}
      ...
      <p className="IsDebug fs-11" style={{ marginTop: 8 }}>{(() => {
        const cerca = catalogo
          ...
          : 'serramenti/cassonetti-in-pvc/non trovata'

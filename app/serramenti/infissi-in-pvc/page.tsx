          ...
          <div className="vetrina-foto-row">
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/serramenti/infissi-in-pvc/pvc-alphaluce.jpg" alt="Infissi in PVC Alphaluce" fill sizes="240px" style={{ objectFit: 'cover' }} />
              </div>
            ...
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/serramenti/infissi-in-pvc/Inalpha-Prestigio21.jpg" alt="Infissi in PVC Inalpha Prestigio" fill sizes="240px" style={{ objectFit: 'cover' }} />
              </div>
              <div style={{ padding: '8px 12px 10px' }}>

...
export default async function Page() {
  const catalogo = await getCatalogoData('serramenti', 'infissi-in-pvc')
          ...
          <div className="vetrina-foto-row">
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/serramenti/infissi-in-pvc/pvc-alphaluce.jpg" alt="Infissi in PVC Alphaluce" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
            ...
            <div className="page-card">
              <div style={{ position: 'relative', width: '100%', height: 148 }}>
                <Image src="/images/serramenti/infissi-in-pvc/Inalpha-Prestigio21.jpg" alt="Infissi in PVC Inalpha Prestigio" fill sizes="300px" style={{ objectFit: 'cover' }} />
              </div>
              <div style={{ padding: '14px 16px' }}>

...
export default function Page() {
  return (
    <div className="fs-15" style={{ maxWidth: 860, margin: '48px auto', padding: '0 20px 64px', color: '#444', lineHeight: 1.8 }}>
      ...
      <h1 className="effetto-3d fs-28" style={{ fontWeight: 700, marginBottom: 16 }}>Avvolgibili Motorizzati a Palermo</h1>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
            <p className="testo-articoli" style={{ margin: 0 }}>
              Installiamo <strong>avvolgibili e tapparelle motorizzate a Palermo</strong>: motori tubulari silenziosi integrati nell&apos;avvolgitore con comando tramite pulsante a parete, telecomando radio o app da smartphone. Compatibili con i principali sistemi domotici — KNX, BTicino, Google Home, Alexa — per l&apos;automazione programmata in base all&apos;ora, al sole e al vento.
            </p>
            <p className="testo-articoli" style={{ margin: 0 }}>
              Le tapparelle sono disponibili in doghe di PVC coibentato (ottimo isolamento termoacustico), alluminio estruso e acciaio zincato per applicazioni di sicurezza. I motori — Somfy, Nice, Came, Rolly — sono dotati di finecorsa meccanico o elettronico e di sistema anti-ostacolo per la sicurezza di bambini e animali.
            </p>
            <p className="testo-articoli" style={{ margin: 0 }}>

...
export default async function Page() {
  const catalogo = await getCatalogoData('serramenti', 'avvolgibili-motorizzati')
  ...
  return (
    <div className="fs-15" style={{ padding: '0 0 64px', color: '#444', lineHeight: 1.8 }}>
      <p className="fs-12" style={{ color: '#000', marginBottom: 8, textShadow: 'none' }}>
        <Link href="/serramenti" style={{ color: '#888', textDecoration: 'underline' }}>Serramenti</Link> / Avvolgibili Motorizzati<ShortcutStar />
      </p>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        {catalogo && (
          <CatalogoWrapper
            ...
            fixedCat="serramenti"
            fixedSottocat="avvolgibili-motorizzati"
          />
        )}
      ...
      <p className="IsDebug fs-11" style={{ marginTop: 8 }}>{(() => {
        const cerca = catalogo
          ...
          : 'serramenti/avvolgibili-motorizzati/non trovata'

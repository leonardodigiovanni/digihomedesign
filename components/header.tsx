  ...
  return (
    ...
    >
      ...
      <div className="header-top-row" style={{ position: 'relative', zIndex: 50, display: 'flex', justifyContent: 'flex-end', alignItems: 'center', minHeight: 80 }}>
        <div style={{ position: 'absolute', left: '50%', top: 0, bottom: 0, margin: 'auto 0', transform: 'translateX(-50%)', display: 'flex', alignItems: 'center', gap: 1, width: 'fit-content', height: 'fit-content', zIndex: 10 }}>
          ...
          <div className="header-comparti-wrap" style={{ transform: 'translateY(-4px)', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'center', width: 'fit-content', zIndex: 10 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 170, background: '#fff', border: '1px solid #000', boxShadow: '0 0 0 1px #fff', borderRadius: 10, padding: '1px 3px 3px', marginBottom: 1 }}>
          ...
          <div className="header-comparti-row" style={{ display: 'flex', width: '100%', alignItems: 'center', justifyContent: 'flex-start', gap: 4 }}>

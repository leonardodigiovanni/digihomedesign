...
const socials = [
  { label: 'WhatsApp',  href: 'https://wa.me/393518716731',                    icon: <IconWhatsApp /> },
  { label: 'Telegram',  href: 'https://t.me/digihomedesign',                   icon: <IconTelegram /> },
  // { label: 'Instagram', href: 'https://www.instagram.com/digihomedesign',      icon: <IconInstagram /> },
  { label: 'Facebook',  href: 'https://www.facebook.com/digihomedesign',       icon: <IconFacebook /> },
  { label: 'TikTok',    href: 'https://www.tiktok.com/@digihomedesign',        icon: <IconTikTok /> },
]
  ...
  return (
    ...
    >
      {socials.map(({ label, href, icon }) => (
        <a key={label} href={href} target="_blank" rel="noopener noreferrer" aria-label={label} title={label} style={{ display: 'flex', alignItems: 'center' }}>
          {icon}
        </a>
      ))}
    </div>

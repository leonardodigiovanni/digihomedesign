...
export default function FornitoreForm() {
        ...
        >
          <div style={{
            ...
            <p style={{ fontSize: 13, color: '#777', marginBottom: 24, lineHeight: 1.5 }}>
              Sei un produttore o distributore e vuoi che vendiamo i tuoi prodotti? Compila il form e ti contatteremo.
            </p>
            ...
            {state?.ok ? (
              ...
              <>
                ...
                <form action={action} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  ...
                  <div>
                    <label style={labelStyle}>Prodotti / settore</label>
                    <textarea
                      name="messaggio"
                      rows={4}
                      style={{ ...inputStyle, resize: 'vertical', lineHeight: 1.6 }}
                      placeholder="Descrivi brevemente i prodotti che vorresti che distribuissimo..."
                    />
                  </div>

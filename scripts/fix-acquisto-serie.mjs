...
const OLD = 'SELECT id, descrizione, produttore, unita, prezzo_vendita, max_acquistabile FROM listini WHERE categoria IN'
const NEW = 'SELECT id, descrizione, produttore, serie, unita, prezzo_vendita, max_acquistabile FROM listini WHERE categoria IN'
